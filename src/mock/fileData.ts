export const REACT_TEMPLATE : any = [
    {
      filename: 'react',
      kind: 'directory',
      path: '/react',
  ...
  export const VANILLA_TEMPLATE : any = [
    {
      filename: 'vanilla',
      kind: 'directory',
      path: '/vanilla',
  ...
  const totalTmp : any = { REACT_TEMPLATE, VUE_TEMPLATE, VANILLA_TEMPLATE };
  export default totalTmp;
